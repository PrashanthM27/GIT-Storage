...
trigger FCST_PutGapPlaningVersionTrigger on Gap_Planning_Version__c (after insert,after update, before delete) {
    
    if(trigger.isInsert || trigger.isUpdate){
        
        List<Gap_Planning_Version__c> lstAdditionalPlanning = [select Id,Name,Version_Description__c from Gap_Planning_Version__c where Id IN: trigger.New];
        ...
        List<Planning_Version__c> lstdeletePlanning = [select Id,Gap_Planning_Version__c from Planning_Version__c where Gap_Planning_Version__c IN: Trigger.OldMap.Keyset()];
